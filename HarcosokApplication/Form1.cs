    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            Button_Letrehoz.Click += (Sender, e) =>
            {
                ...
                if (Harcos_Text_Box.Text != null && !Harcos_Text_Box.Text.Trim(' ', ';').Equals(""))
                {
                    var ellenorzes_insert = conn.CreateCommand();
                    string nev = Harcos_Text_Box.Text.Trim(' ', ';');
                    ...
                    if (hossz == 0)
                    {
                        ...
                        Harcosok_Frissites();
                        MessageBox.Show("Karakter sikeresen létrehozva!");
                    }
                    else
                    {
                        MessageBox.Show("Már létezik ez a harcos!");
                    }

                }
                else { MessageBox.Show("Kérem adjon meg egy rendes nevet!"); }
            };
            ...
            ComboBox_Hasznalo.SelectedIndexChanged += (sender, e) =>
            {
                ...
                Kepesseg_Frissites(Id_Kereso());
                TextBox_Kepesseg_Leirasa.Text = "Nincsen kiválasztott képességed";
            };
            ...
            ListBox_Kepessegek.SelectedIndexChanged += (sender, e) =>
            {
                if (ListBox_Kepessegek.SelectedIndex > -1)
                {
                    ...
                    string nev = "Nincsen kiválasztott képességed";
                    while (olvas.Read())
                    {
            ...
            Button_Modosit.Click += (sender, e) =>
            {
                ...
                else { MessageBox.Show("Módosítás előtt válasz ki egy képességet!"); }
            };
            ...
            Button_Torles.Click += (sender, e) =>
            {
                if (ListBox_Kepessegek.SelectedItem != null)
                {
                    ...
                    Kepesseg_Frissites(Id_Kereses_ListBox());
                    TextBox_Kepesseg_Leirasa.Text = "Nem választottál képességet!";
                    MessageBox.Show("Sikeres törlés!");
                }
                else { MessageBox.Show("Nincs kiválasztva képességed!"); }
            };
